...
#Saving the model
path = os.path.join('checkpoints', 'word_pred_Model44.h5')

#Saving the checkpoints
checkpoint = ModelCheckpoint(path, monitor='loss', verbose=1, save_best_only=True, mode='min')

#Fitting the model
model.fit(train_inputs,train_targets,batch_size=128,epochs=500,shuffle=True,verbose=1,callbacks=[checkpoint])

#Saving the tokenizer model
dump(tokenizer,open('tokenizer_Model44','wb'))
